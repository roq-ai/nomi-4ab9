...
CREATE TABLE "project" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "name" VARCHAR(255) NOT NULL,
    "sdg_focus" VARCHAR(255) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "feedback" ADD CONSTRAINT "feedback_team_member_id_fkey" FOREIGN KEY ("team_member_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "project" ADD CONSTRAINT "project_team_leader_id_fkey" FOREIGN KEY ("team_leader_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
