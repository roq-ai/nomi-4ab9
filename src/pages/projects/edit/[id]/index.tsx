      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="sdg_focus" mb="4" isInvalid={!!formik.errors?.sdg_focus}>
              <FormLabel>Sdg Focus</FormLabel>
              <Input type="text" name="sdg_focus" value={formik.values?.sdg_focus} onChange={formik.handleChange} />
              {formik.errors.sdg_focus && <FormErrorMessage>{formik.errors?.sdg_focus}</FormErrorMessage>}
            </FormControl>
